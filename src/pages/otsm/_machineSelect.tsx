...
const MachineSelect: FC<SelectorProps> = ({ toggleDropdown, toggleContent }) => {
    ...
    function resetSelection() {
        ...
        document.querySelector('.otsm__machine.otsm__dropdown__button')?.classList.replace('is-primary', 'is-danger')
        document.querySelectorAll('.otsm__machine.otsm__dropdown__item').forEach((element) => {
            ...
            <div className="otsm__machine__dropdown dropdown">
                ...
                <div className="dropdown-menu" id="dropdown-menu" role="menu">
                    <div className="dropdown-content">
                        <a className="otsm__machine otsm__dropdown__item 1 dropdown-item" onClick={(e: React.MouseEvent) => {
                            toggleContent(e, 1)
